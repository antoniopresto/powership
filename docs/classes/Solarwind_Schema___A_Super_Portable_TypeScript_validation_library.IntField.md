[Backland](../README.md) / [Modules](../modules.md) / [Backland Schema - A Super Portable TypeScript validation library](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md) / IntField

# Class: IntField

[Backland Schema - A Super Portable TypeScript validation library](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md).IntField

## Hierarchy

- [`FieldType`](Backland_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`number`, ``"int"``, [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef) \| `undefined`\>
...
- [constructor](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#constructor)

### Properties

- [\_\_\_inferable](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#___inferable)
- [\_\_isFieldType](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#__isfieldtype)
- [composer](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#composer)
- [def](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#def)
- [defaultValue](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#defaultvalue)
- [description](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#description)
- [hidden](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#hidden)
- [id](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#id)
- [list](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#list)
- [name](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#name)
- [optional](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#optional)
- [options](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#options)
- [parse](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#parse)
- [type](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#type)
- [typeName](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#typename)

### Accessors

- [asFinalFieldDef](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#asfinalfielddef)
- [definition](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#definition)

### Methods

- [applyParser](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#applyparser)
- [clone](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#clone)
- [describe](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#describe)
- [describeField](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#describefield)
- [is](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#is)
- [setDefaultValue](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#setdefaultvalue)
- [toList](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#tolist)
- [toOptional](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#tooptional)
- [toRequired](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#torequired)
- [validate](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#validate)
- [create](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md#create)
...
| Name | Type |
| :------ | :------ |
| `def` | [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef) |
...
• `Readonly` **def**: `undefined` \| [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef)
...
▸ **setDefaultValue**<`T`\>(`value`): [`FieldType`](Backland_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`number`, ``"int"``, `undefined` \| [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef), ``0``, ``0``, `T`, {}\>
...
[`FieldType`](Backland_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`number`, ``"int"``, `undefined` \| [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef), ``0``, ``0``, `T`, {}\>
...
▸ **toList**(`options?`): [`FieldType`](Backland_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`number`, ``"int"``, `undefined` \| [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef), ``1``, ``0``, `undefined`, {}\>
...
[`FieldType`](Backland_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`number`, ``"int"``, `undefined` \| [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef), ``1``, ``0``, `undefined`, {}\>
...
▸ **toOptional**(): [`FieldType`](Backland_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`number`, ``"int"``, `undefined` \| [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef), ``0``, ``1``, `undefined`, {}\>

#### Returns

[`FieldType`](Backland_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`number`, ``"int"``, `undefined` \| [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef), ``0``, ``1``, `undefined`, {}\>
...
▸ **toRequired**(): [`FieldType`](Backland_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`number`, ``"int"``, `undefined` \| [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef), ``0``, ``0``, `undefined`, {}\>

#### Returns

[`FieldType`](Backland_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`number`, ``"int"``, `undefined` \| [`IntFieldDef`](../modules/Backland_Schema___A_Super_Portable_TypeScript_validation_library.md#intfielddef), ``0``, ``0``, `undefined`, {}\>
...
▸ `Static` **create**(`def?`): [`IntField`](Backland_Schema___A_Super_Portable_TypeScript_validation_library.IntField.md)
