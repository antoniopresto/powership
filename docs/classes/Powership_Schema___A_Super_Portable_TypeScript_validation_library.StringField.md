[Powership](../README.md) / [Modules](../modules.md) / [Powership Schema - A Super Portable TypeScript validation library](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md) / StringField

# Class: StringField

[Powership Schema - A Super Portable TypeScript validation library](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md).StringField

## Hierarchy

- [`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`string`, ``"string"``, [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef) \| `undefined`\>
...
- [constructor](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#constructor)

### Properties

- [$](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#$)
- [\_\_\_inferable](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#___inferable)
- [\_\_isFieldType](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#__isfieldtype)
- [composer](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#composer)
- [def](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#def)
- [defaultValue](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#defaultvalue)
- [description](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#description)
- [hidden](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#hidden)
- [id](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#id)
- [list](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#list)
- [name](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#name)
- [optional](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#optional)
- [options](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#options)
- [parse](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#parse)
- [type](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#type)
- [typeName](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#typename)

### Accessors

- [asFinalFieldDef](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#asfinalfielddef)
- [definition](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#definition)

### Methods

- [applyParser](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#applyparser)
- [clone](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#clone)
- [describe](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#describe)
- [describeField](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#describefield)
- [is](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#is)
- [setDefaultValue](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#setdefaultvalue)
- [toList](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#tolist)
- [toOptional](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#tooptional)
- [toRequired](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#torequired)
- [validate](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#validate)
- [create](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md#create)
...
| Name | Type |
| :------ | :------ |
| `def` | [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef) |
...
packages/schema/src/fields/StringField.ts:19
...
• `Readonly` **def**: `undefined` \| [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef)
...
packages/schema/src/fields/StringField.ts:17
...
▸ **setDefaultValue**<`T`\>(`value`): [`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`string`, ``"string"``, `undefined` \| [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef), ``0``, ``0``, `T`, {}\>
...
[`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`string`, ``"string"``, `undefined` \| [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef), ``0``, ``0``, `T`, {}\>
...
▸ **toList**(`options?`): [`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`string`, ``"string"``, `undefined` \| [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef), ``1``, ``0``, `undefined`, {}\>
...
[`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`string`, ``"string"``, `undefined` \| [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef), ``1``, ``0``, `undefined`, {}\>
...
▸ **toOptional**(): [`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`string`, ``"string"``, `undefined` \| [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef), ``0``, ``1``, `undefined`, {}\>

#### Returns

[`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`string`, ``"string"``, `undefined` \| [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef), ``0``, ``1``, `undefined`, {}\>
...
▸ **toRequired**(): [`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`string`, ``"string"``, `undefined` \| [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef), ``0``, ``0``, `undefined`, {}\>

#### Returns

[`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`string`, ``"string"``, `undefined` \| [`StringFieldDef`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#stringfielddef), ``0``, ``0``, `undefined`, {}\>
...
▸ `Static` **create**(`def?`): [`StringField`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.StringField.md)
...
packages/schema/src/fields/StringField.ts:61
