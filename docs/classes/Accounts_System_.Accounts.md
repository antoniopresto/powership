...
[packages/accounts/src/Accounts.ts:54](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L54)
...
[packages/accounts/src/Accounts.ts:51](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L51)
...
[packages/accounts/src/Accounts.ts:49](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L49)
...
[packages/accounts/src/Accounts.ts:52](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L52)
...
[packages/accounts/src/Accounts.ts:50](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L50)
...
[packages/accounts/src/Accounts.ts:47](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L47)
...
▸ (`options`): `EntityFromContext`<`EntityTypesContext`<`Omit`<`Omit`<`Omit`<`Object`, ``"sessions"``\> & { `sessions`: { `array`: { `of`: `GraphType`<{ `object`: `Omit`<`EntityDocumentBaseDef`<``true``\>, ``"accountId"`` \| ``"token"`` \| ``"valid"`` \| ``"connectionInfo"``\> & { `accountId`: ``"string"`` = 'string'; `connectionInfo`: `GraphType`<{ `object`: { `$string`: ``"unknown"`` = 'unknown'; `ip`: ``"string?"`` = 'string?'; `userAgent`: ``"string?"`` = 'string?' }  }\> = SessionConnectionInfo; `token`: ``"string"`` = 'string'; `valid`: ``"boolean"`` = 'boolean' }  }\>  }  }  }, ``"accessTypes"``\> & { `accessTypes`: { `array`: { `of`: `GraphType`<{ `object`: `Omit`<`EntityDocumentBaseDef`<``true``\>, ``"meta"`` \| ``"accountId"`` \| ``"data"`` \| ``"verified"``\> & { `accountId`: ``"ID"`` = 'ID'; `data`: `GraphType`<{ `union`: readonly [{ `object`: { `kind`: { `literal`: ``"email"`` = accessTypesEnum.email } ; `value`: ``"email"`` = 'email' }  }, { `object`: { `kind`: { `literal`: ``"phone"`` = accessTypesEnum.phone } ; `value`: ``"phone"`` = accessTypesEnum.phone }  }, { `object`: { `authToken`: ``"string"`` = 'string'; `kind`: { `literal`: ``"oauth"`` = accessTypesEnum.oauth } ; `provider`: { `description`: ``"Provider name"`` = 'Provider name'; `string`: {} = {} } ; `value`: { `alias`: ``"provider"`` = 'provider' }  }  }, { `object`: { `kind`: { `literal`: ``"custom"`` = accessTypesEnum.custom } ; `meta`: ``"record"`` = 'record'; `value`: ``"string"`` = 'string' }  }]  }\> = AccessTypeUnion; `meta`: ``"record?"`` = 'record?'; `verified`: ``"boolean?"`` = 'boolean?' }  }\>  }  }  }, ``"tokens"``\> & { `tokens`: { `array`: { `of`: `GraphType`<{ `object`: `Omit`<`EntityDocumentBaseDef`<``true``\>, ``"meta"`` \| ``"accountId"`` \| ``"value"`` \| ``"kind"`` \| ``"reason"`` \| ``"createdFor"`` \| ``"used"`` \| ``"usageLocations"`` \| ``"location"``\> & { `accountId`: ``"ID"`` = 'ID'; `createdFor`: { `description`: `string` ; `string`: { `min`: ``2`` = 2 }  } ; `kind`: { `description`: ``"Examples: 2fa, password_recovery"`` = 'Examples: 2fa, password\_recovery'; `enum`: (``"password"`` \| ``"custom"`` \| ``"email_verification"`` \| ``"phone_verification"`` \| ``"password_recovery"`` \| ``"magick_link"`` \| ``"twoFactorAuth"``)[] = tokenKindEnum.list } ; `location`: { `object`: { `device`: ``"string?"`` = 'string?'; `ip`: ``"string?"`` = 'string?'; `meta`: ``"record?"`` = 'record?' } ; `optional`: ``true`` = true } ; `meta`: ``"record?"`` = 'record?'; `reason`: ``"string?"`` = 'string?'; `usageLocations`: { `list`: ``true`` = true; `object`: { `device`: ``"string?"`` = 'string?'; `ip`: ``"string?"`` = 'string?'; `meta`: ``"record?"`` = 'record?' } ; `optional`: ``true`` = true } ; `used`: { `boolean`: {} = {}; `defaultValue`: ``false`` = false; `optional`: ``true`` = true } ; `value`: { `string`: { `max`: ``1000`` = 1000; `min`: ``4`` = 4 }  }  }  }\>  }  }  }, ({ `PK`: ``".accountId"``[] ; `name`: `string` = '\_id' } \| { `PK`: ``".username"``[] ; `name`: `string` = '\_id2' })[]\>\>
...
[packages/accounts/src/Accounts.ts:43](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L43)
...
[packages/accounts/src/Accounts.ts:366](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L366)
...
[packages/accounts/src/Accounts.ts:374](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L374)
...
[packages/accounts/src/Accounts.ts:370](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L370)
...
[packages/accounts/src/Accounts.ts:216](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L216)
...
[packages/accounts/src/Accounts.ts:67](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L67)
...
[packages/accounts/src/Accounts.ts:301](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L301)
...
[packages/accounts/src/Accounts.ts:286](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L286)
...
[packages/accounts/src/Accounts.ts:176](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L176)
...
[packages/accounts/src/Accounts.ts:316](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L316)
...
[packages/accounts/src/Accounts.ts:144](https://github.com/antoniopresto/powership/blob/2672a73/packages/accounts/src/Accounts.ts#L144)
