[Powership](../README.md) / [Modules](../modules.md) / [Powership Schema - A Super Portable TypeScript validation library](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md) / UndefinedField

# Class: UndefinedField

[Powership Schema - A Super Portable TypeScript validation library](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md).UndefinedField

## Hierarchy

- [`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`undefined`, ``"undefined"``, `undefined`\>
...
- [constructor](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#constructor)

### Properties

- [$](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#$)
- [\_\_\_inferable](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#___inferable)
- [\_\_isFieldType](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#__isfieldtype)
- [composer](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#composer)
- [def](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#def)
- [defaultValue](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#defaultvalue)
- [description](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#description)
- [hidden](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#hidden)
- [id](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#id)
- [list](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#list)
- [name](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#name)
- [optional](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#optional)
- [options](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#options)
- [parse](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#parse)
- [type](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#type)
- [typeName](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#typename)

### Accessors

- [asFinalFieldDef](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#asfinalfielddef)
- [definition](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#definition)

### Methods

- [applyParser](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#applyparser)
- [clone](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#clone)
- [describe](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#describe)
- [describeField](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#describefield)
- [is](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#is)
- [setDefaultValue](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#setdefaultvalue)
- [toList](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#tolist)
- [toOptional](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#tooptional)
- [toRequired](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#torequired)
- [validate](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#validate)
- [create](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md#create)
...
packages/schema/src/fields/UndefinedField.ts:12
...
• **composer**: `undefined` \| [`FieldComposer`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#fieldcomposer)<`Record`<`string`, `any`\>, `undefined`\>
...
• **parse**: [`FieldTypeParser`](../modules/Powership_Schema___A_Super_Portable_TypeScript_validation_library.md#fieldtypeparser)<`undefined`\>
...
packages/schema/src/fields/UndefinedField.ts:10
...
▸ **setDefaultValue**<`T`\>(`value`): [`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`undefined`, ``"undefined"``, `undefined`, ``0``, ``0``, `T`, {}\>
...
[`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`undefined`, ``"undefined"``, `undefined`, ``0``, ``0``, `T`, {}\>
...
▸ **toList**(`options?`): [`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`undefined`, ``"undefined"``, `undefined`, ``1``, ``0``, `undefined`, {}\>
...
[`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`undefined`, ``"undefined"``, `undefined`, ``1``, ``0``, `undefined`, {}\>
...
▸ **toOptional**(): [`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`undefined`, ``"undefined"``, `undefined`, ``0``, ``1``, `undefined`, {}\>

#### Returns

[`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`undefined`, ``"undefined"``, `undefined`, ``0``, ``1``, `undefined`, {}\>
...
▸ **toRequired**(): [`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`undefined`, ``"undefined"``, `undefined`, ``0``, ``0``, `undefined`, {}\>

#### Returns

[`FieldType`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.FieldType.md)<`undefined`, ``"undefined"``, `undefined`, ``0``, ``0``, `undefined`, {}\>
...
▸ `Static` **create**(): [`UndefinedField`](Powership_Schema___A_Super_Portable_TypeScript_validation_library.UndefinedField.md)
...
packages/schema/src/fields/UndefinedField.ts:24
