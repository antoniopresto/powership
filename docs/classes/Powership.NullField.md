[Powership](../README.md) / [Modules](../modules.md) / [Powership](../modules/Powership.md) / NullField

# Class: NullField

[Powership](../modules/Powership.md).NullField

## Hierarchy

- [`FieldType`](Powership.FieldType.md)<`string`, ``"null"``, `undefined`\>
...
- [constructor](Powership.NullField.md#constructor)

### Properties

- [$](Powership.NullField.md#$)
- [\_\_\_inferable](Powership.NullField.md#___inferable)
- [\_\_isFieldType](Powership.NullField.md#__isfieldtype)
- [applyParser](Powership.NullField.md#applyparser)
- [clone](Powership.NullField.md#clone)
- [composer](Powership.NullField.md#composer)
- [def](Powership.NullField.md#def)
- [defaultValue](Powership.NullField.md#defaultvalue)
- [describe](Powership.NullField.md#describe)
- [describeField](Powership.NullField.md#describefield)
- [description](Powership.NullField.md#description)
- [hidden](Powership.NullField.md#hidden)
- [id](Powership.NullField.md#id)
- [list](Powership.NullField.md#list)
- [name](Powership.NullField.md#name)
- [optional](Powership.NullField.md#optional)
- [options](Powership.NullField.md#options)
- [parse](Powership.NullField.md#parse)
- [type](Powership.NullField.md#type)
- [typeName](Powership.NullField.md#typename)
- [create](Powership.NullField.md#create)

### Accessors

- [asFinalFieldDef](Powership.NullField.md#asfinalfielddef)
- [definition](Powership.NullField.md#definition)

### Methods

- [is](Powership.NullField.md#is)
- [setDefaultValue](Powership.NullField.md#setdefaultvalue)
- [toList](Powership.NullField.md#tolist)
- [toOptional](Powership.NullField.md#tooptional)
- [toRequired](Powership.NullField.md#torequired)
- [validate](Powership.NullField.md#validate)
...
• **clone**: () => [`FieldType`](Powership.FieldType.md)<`string`, ``"null"``, `undefined`, ``0``, ``0``, `undefined`, {}\>

#### Type declaration

▸ (): [`FieldType`](Powership.FieldType.md)<`string`, ``"null"``, `undefined`, ``0``, ``0``, `undefined`, {}\>
...
• **describe**: (`description`: `string`) => [`NullField`](Powership.NullField.md)

#### Type declaration

▸ (`description`): [`NullField`](Powership.NullField.md)
...
• **describeField**: () => { `$?`: [`CustomFieldConfig`](../interfaces/Powership.CustomFieldConfig.md) ; `def`: `undefined` ; `defaultValue`: `undefined` ; `description`: `undefined` \| `string` ; `hidden`: `boolean` ; `list`: ``false`` ; `optional`: ``false`` ; `type`: `string`  }
...
▪ `Static` **create**: () => [`NullField`](Powership.NullField.md)
...
▸ **setDefaultValue**<`T`\>(`value`): [`FieldType`](Powership.FieldType.md)<`string`, ``"null"``, `undefined`, ``0``, ``0``, `T`, {}\>
...
[`FieldType`](Powership.FieldType.md)<`string`, ``"null"``, `undefined`, ``0``, ``0``, `T`, {}\>
...
▸ **toList**(`options?`): [`FieldType`](Powership.FieldType.md)<`string`, ``"null"``, `undefined`, ``1``, ``0``, `undefined`, {}\>
...
[`FieldType`](Powership.FieldType.md)<`string`, ``"null"``, `undefined`, ``1``, ``0``, `undefined`, {}\>
...
▸ **toOptional**(): [`FieldType`](Powership.FieldType.md)<`string`, ``"null"``, `undefined`, ``0``, ``1``, `undefined`, {}\>

#### Returns

[`FieldType`](Powership.FieldType.md)<`string`, ``"null"``, `undefined`, ``0``, ``1``, `undefined`, {}\>
...
▸ **toRequired**(): [`FieldType`](Powership.FieldType.md)<`string`, ``"null"``, `undefined`, ``0``, ``0``, `undefined`, {}\>
