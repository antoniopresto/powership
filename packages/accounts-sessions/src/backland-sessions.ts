...
export interface BacklandSessionOptions {
...
export class BacklandSessions implements DatabaseInterfaceSessions {
  // Merged options that can be used
  private options: BacklandSessionOptions & typeof defaultOptions;
  // Mongo database object
  private database: Db;
  // Mongo session collection
  private sessionCollection: Collection;

  constructor(options: BacklandSessionOptions) {
    this.options = {
      ...defaultOptions,
      ...options,
