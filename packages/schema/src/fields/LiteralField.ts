import { BJSON, inspectObject, watchable } from '@powership/utils';
...
export const LiteralField = watchable(() => {
  return class LiteralField<T extends Readonly<Serializable>> extends FieldType<
    T,
    'literal',
    LiteralFieldDef
  > {
