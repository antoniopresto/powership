...
describe('FieldTypes', () => {
  ...
  describe('EnumField', () => {
    ...
    test('types', () => {
      ...
      expect(gql.typeToString().split('\n')).toEqual([
        'type TempEnumField {',
        '  name: TempEnumField_nameEnum!',
        '  nameFromType: [TempEnumField_nameFromTypeEnum]',
        '  defObject: [TempEnumField_defObjectEnum]',
        '}',
        '',
        'enum TempEnumField_nameEnum {',
        '  a',
        '  x',
        '}',
        '',
        'enum TempEnumField_nameFromTypeEnum {',
        '  a',
        '  x',
        '}',
        '',
        'enum TempEnumField_defObjectEnum {',
        '  a',
        '  x',
        '}',
      ]);
  ...
  describe('RecordField', () => {
    ...
    test('types', () => {
      ...
      expect(gql.typeToString().split('\n')).toEqual([
        'type TempRecord {',
        '  name: TempRecord_nameRecord!',
        '  nameOpt: TempRecord_nameOptRecord',
        '  nameList: [TempRecord_nameListRecord]!',
        '  nameListOptional: [TempRecord_nameListOptionalRecord]',
        '  nameFromType: [TempRecord_nameFromTypeRecord]',
        '  defObject: [TempRecord_defObjectRecord]',
        '}',
        '',
        'scalar TempRecord_nameRecord',
        '',
        'scalar TempRecord_nameOptRecord',
        '',
        'scalar TempRecord_nameListRecord',
        '',
        'scalar TempRecord_nameListOptionalRecord',
        '',
        'scalar TempRecord_nameFromTypeRecord',
        '',
        'scalar TempRecord_defObjectRecord',
      ]);
  ...
  describe('CursorField', () => {
    it('parses', () => {
      ...
      ).toThrow(`➤ field "PK": required field.`);
