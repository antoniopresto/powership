...
describe('generateQuery', () => {
  ...
  it('simple field', async () => {
    ...
    expect(sut.fullQuery.split('\n')).toEqual([
      ...
      '  parentId',
      '}',
      'fragment Product727719921Fragment($productById_parents_id: ID! = "155") on Product {',
      '  sku',
      '  breadcrumb {',
      '    ...Breadcrumb2402738501Fragment',
      '  }',
      '  parents(id: $productById_parents_id) {',
      '    ...Product727719921Fragment',
      '  }',
      '  innerParent(limit: $productById_parents_innerParent_limit) {',
      '    ...Product2761445794Fragment',
      '  }',
      '}',
      'fragment Product2761445794Fragment($productById_parents_innerParent_limit: Int! = "2") on Product {',
      '  sku',
      '  breadcrumb {',
      '    ...Breadcrumb2402738501Fragment',
      '  }',
