...
import { generateClientUtils } from '../generateClientUtils';

describe('getGraphQLTypescript', () => {
  ...
  it('works', async () => {
    ...
    const sut = await generateClientUtils(schema);
    ...
    expect(sut.split('\n')).toEqual([
      ...
      "        __dschm__: { type: 'meta', def: { id: 'User' } },",
      '      },',
      '      list: true,',
      '      optional: false,',
      "      description: 'user entity',",
      ...
      "        __dschm__: { type: 'meta', def: { id: null } },",
      '      },',
      '      optional: false,',
      '      list: false,',
      '    } as const),',
