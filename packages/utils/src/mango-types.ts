...
export type MangoQuerySelector<DocType> = Partial<{
  [Property in Paths<DocType>]:
    | MangoQueryOperators<any>
    | PropertyType<DocType, Property>;
}> & {
...
export type MangoQueryNoLimit<RxDocType> =
  MangoQuerySelectorAndIndex<RxDocType> & {
    /**
...
export type MangoInlineQuery<
  RxDocumentType = any,
  RxQueryResult = RxDocumentType | RxDocumentType[]
> = {
  equals(queryObj: any): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  eq(queryObj: any): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  or(
    queryObj: keyof RxDocumentType | string | any[]
  ): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  nor(
    queryObj: keyof RxDocumentType | string | any[]
  ): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  and(
  ...
  gt(queryObj: any): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  gte(queryObj: any): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  lt(queryObj: any): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  lte(queryObj: any): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  ne(queryObj: any): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  in(queryObj: any[]): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  nin(queryObj: any[]): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  all(queryObj: any): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  regex(queryObj: RegExp): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  exists(queryObj: any): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  elemMatch(queryObj: any): MangoInlineQuery<RxDocumentType, RxQueryResult>;
  mod(
    p1: any,
    p2: any,
    p3: any
